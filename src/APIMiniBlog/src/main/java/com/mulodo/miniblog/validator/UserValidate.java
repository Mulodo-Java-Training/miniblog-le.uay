...
public class UserValidate
{
            ...
            String password, String email)
    {
        ...
        if (isValid) {
            ...
            isValid = ValidatorUtils.isValidLength(username, Constraints.MIN_USERNAME,
                    Constraints.MAX_USERNAME);
            if (!isValid) {
                // check if have error, add message error to listmessage
     ...
     * @return Meta
     */
    public static Meta validateUpdate(String firstname, String lastname, String email,
     ...
     *
     * @param name
     *            : username, firstname or lastname of user
     * @return Meta
     */
