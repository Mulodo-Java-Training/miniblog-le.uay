	...
	public List<Comment> getAllCommentForPost(int post_id, Boolean isOwnerPost)
		...
		try{
	        ...
	        criteria.setProjection(Projections.projectionList()
		        		...
		        		.add(Projections.property("us.id"))
	        ...
	        if(!criteria.list().isEmpty()){
	        	...
	        	for (Iterator<Object[]> it = result.iterator(); it.hasNext();) {
	        	    ...
	        	    comment.setUser(new User((int) myResult[4], (String) myResult[5], (int) myResult[6]));
	...
	public List<Comment> getAllCommentForUser(int user_id, Boolean isOwnerUser)
		...
		try{
	        ...
	        criteria.setProjection(Projections.projectionList()
		        		...
		        		.add(Projections.property("created_at"))
		        		.add(Projections.property("modified_at"))
		        		.add(Projections.property("us.id"))
		        		.add(Projections.property("us.username"))
		        		.add(Projections.property("us.status")));
//	        		.setResultTransformer(new AliasToBeanResultTransformer(Comment.class)); 
	        ...
	        if(isOwnerUser){
	        	...
	        	Criterion criterionCurrentActive = Restrictions.eq("pt.status", Constraints.POST_ACTIVE);
