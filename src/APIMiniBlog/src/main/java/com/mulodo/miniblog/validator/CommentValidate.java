...
public class CommentValidate {
	 ...
	 *	
	 *	@param	comment_id : comment_id of comment
	 *  @param  content : content of post
	 *	
	 *  @return Meta
	 *	
	...
	/**
	 *  validate_get_all_comment_for_post use for validate get all comment for user
	 *	
	 *	@param	post_id : post_id of post
	 *	
	 *  @return Meta
	 *	
	 */
	...
	/**
	 *  validate_get_all_comment_for_user use for validate get all comment for user
	 *	
