 ...
 * @author UayLU
 */
public class PostUpdateMockitoUnitTest
{
    ...
    public void testActiveDeactivePost() throws HandlerException
    {
        ...
        when(postValidate.validateUpdate("100000", "Post test title", "Post test content"))
                .thenReturn(null);
        respone = postController.updatePost(
                "3c50c84079be8b88ee1296ca0cfe0d81443291eaaa73c1ddca498323527948b", "100000",
                "Post test title", "Post test content");
        ...
        when(postValidate.validateUpdate("2", "Post test title", "Post test content")).thenReturn(
                null);
        respone = postController.updatePost(
