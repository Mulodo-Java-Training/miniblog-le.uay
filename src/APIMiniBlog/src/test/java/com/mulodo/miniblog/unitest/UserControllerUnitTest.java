...
public class UserControllerUnitTest 
{
	...
	public void add_new() throws Exception {
		...
		requestValidateData.content("username=  &password=&firstname=ss  &lastname=&email=le.thanh".getBytes());
	...
	public void update() throws Exception {
		...
		String access_key = login_for_test("le.tung","abcd1234");
		System.out.println("acc "+ access_key);
		...
		requestValidateDataSecond.contentType(MediaType.APPLICATION_FORM_URLENCODED);
		requestValidateDataSecond.content(("password=abcd&firstname=first name more than 45 character "
		...
		requestValidatePassword.content("password=abcd12345&firstname=tung&lastname=le&email=le.huy@mulodo.com&status=1".getBytes());
		//set access key to header and send to logout api
		...
		requestUpdateSuccess.content("password=abcd1234&firstname=le.tung2&lastname=le.t&email=le.tung2@mulodo.com&status=0".getBytes());
		...
		requestUpdateAgain.content("password=abcd1234&firstname=le.tung&lastname=le.tung&email=le.tung@mulodo.com&status=1".getBytes());
	...
	public void change_password() throws Exception {
		...
		requestChangePasswordSuccess.content("oldPassword=abcd1234&newPassword=4321dcba".getBytes());
		//post data to add user api
		response = new MockHttpResponse();
