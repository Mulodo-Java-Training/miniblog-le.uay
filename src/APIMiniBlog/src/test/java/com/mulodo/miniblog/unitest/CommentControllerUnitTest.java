...
public class CommentControllerUnitTest
{
    ...
    private final static CommentService commentService = (CommentService) appContext
    ...
    public void deleteComment() throws Exception
    {
        ...
        // set url
        MockHttpRequest requestPermissionComment = MockHttpRequest.delete("/comments/delete/"+comment.getId());
        // /==validate post data==
        requestPermissionComment.header(Constraints.ACCESS_KEY, access_key);
        // post data to add user api
        response = new MockHttpResponse();
        ...
        // set url
        MockHttpRequest requestDeleteCommentSuccess = MockHttpRequest.delete("/comments/delete/"+comment.getId());
        // /==validate post data==
    ...
    /**
     * getAllCommentForUser post for unit testing getAllCommentForUser in commentcontroller
     *
     * @return
     * @exception Exception
     */
    ...
    public void getAllCommentForUser() throws Exception
    {
        ...
        MockHttpRequest requestInvalidComment = MockHttpRequest.get("/comments/getByUser?user_id="+user.getId());
        // /==validate post data==
        requestInvalidComment.header(Constraints.ACCESS_KEY, access_key);
        // post data to add user api
        response = new MockHttpResponse();
        ...
        // set url
        MockHttpRequest requestDeleteCommentSuccess = MockHttpRequest.get("/comments/getByUser?user_id="+user.getId());
        // /==validate post data==
        requestDeleteCommentSuccess.header(Constraints.ACCESS_KEY, access_key);
        // post data to add user api
        response = new MockHttpResponse();
    ...
    /**
     * getAllCommentForPost post for unit testing getAllCommentForPost in commentcontroller
     *
     * @return
     * @exception Exception
     */
    ...
    public void getAllCommentForPost() throws Exception
    {
        ...
        MockHttpRequest requestInvalidPost = MockHttpRequest.get("/comments/getByPost?post_id=10000");
        requestInvalidPost.header(Constraints.ACCESS_KEY, access_key);
        // call method update
        response = new MockHttpResponse();
        dispatcher.invoke(requestInvalidPost, response);
        ...
        jsonObject = new JSONObject(response.getContentAsString());
        // get meta json object
        System.out.println("content return "+ response.getContentAsString());
        ...
        // ==get all comment for owner post==
        MockHttpRequest requestInvalidComment = MockHttpRequest.get("/comments/getByPost?post_id="+post.getId());
        // /==validate post data==
        requestInvalidComment.header(Constraints.ACCESS_KEY, access_key);
        // post data to add user api
        response = new MockHttpResponse();
        ...
        // set url
        MockHttpRequest requestDeleteCommentSuccess = MockHttpRequest.get("/comments/getByPost?post_id="+post.getId());
        // /==validate post data==
        requestDeleteCommentSuccess.header(Constraints.ACCESS_KEY, access_key);
        // post data to add user api
        response = new MockHttpResponse();
