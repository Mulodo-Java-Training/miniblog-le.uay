...
public class PostActiveDeactiveMockitoUnitTest
{
    ...
    public void testActiveDeactivePost() throws HandlerException
    {
        ...
        when(postValidate.validateActiveDeactive("", "")).thenReturn(meta);

        Response respone = postController.activeDeactivePost("", "", "");
        ...
        when(postValidate.validateActiveDeactive("100000", "1")).thenReturn(null);
        respone = postController.activeDeactivePost(
                "3c50c84079be8b88ee1296ca0cfe0d81443291eaaa73c1ddca498323527948b", "100000", "1");
        ...
        when(postValidate.validateActiveDeactive("2", "1")).thenReturn(null);
        respone = postController.activeDeactivePost(
                "3c50c84079be8b88ee1296ca0cfe0d81443291eaaa73c1ddca498323527948b", "2", "1");
        // get json object from response
        jsonObject = new JSONObject(respone.getEntity().toString());
        // get meta json object
        jsonObject = jsonObject.getJSONObject(Constraints.META);
        ...
        when(postValidate.validateActiveDeactive("1", "1")).thenReturn(null);
        respone = postController.activeDeactivePost(
                "3c50c84079be8b88ee1296ca0cfe0d81443291eaaa73c1ddca498323527948b", "1", "1");
        // get json object from response
        jsonObject = new JSONObject(respone.getEntity().toString());
        // get meta json object
        jsonObject = jsonObject.getJSONObject(Constraints.META);
