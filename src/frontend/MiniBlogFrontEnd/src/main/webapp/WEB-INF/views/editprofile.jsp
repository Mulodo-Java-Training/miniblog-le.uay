		...
		$('#edit-profile-form').validate(
		{
			...
			submitHandler : function() {
				...
				.done(function(data) {
						$('#spinner').fadeOut();
						if (data.message
								&& data.message == "Account update success") {
							$('#message').text(data.message);
							$('#passwordError').text('');
							$('#firstnameError').text('');
							$('#lastnameError').text('');
			...
			<div class="container" style="background-color: #9fc78a;">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<form class="navbar-form" style="display: inline-block;"
						action="../searchUser" method="get" id="search-form" name="search-form">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="active"><a href="../profile" class="blog-name">Uay Le U</a></li>
										...
										<div class="col-sm-12 col-md-12" style="margin: 0px;">
												...
												<div class="col-md-9" style="height: 69px;">
													...
													<div class="col-md-12">
														<div style="text-align: left;">
															<span class="message" id="firstnameError">${firstnameError}</span>
														</div>
													</div>
											...
											<div class="form-group" id="group-input-message">
												...
												<div class="col-md-9" style="height: 69px;">
													...
													<div class="col-md-12">
														<div style="text-align: left;">
															<span class="message" id="lastnameError">${lastnameError}</span>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group" id="group-input-message"
												...
												<div class="col-md-9" style="height: 69px;">
													...
													<div class="col-md-12">
														<div style="text-align: left;">
															<span class="message" id="emailError">${emailError}</span>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group" id="group-input-message">
												...
												<div class="col-md-9" style="height: 69px;">
													...
													<div class="col-md-12">
														<div style="text-align: left;">
															<span class="message" id="passwordError">${passwordError}</span>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group" style="text-align: center;">
												<input type="submit" class="m-btn blue" style="width: 100px"
													value="Edit" id="buttonSubmit"> <input
													id="btn btn-danger" class="m-btn blue" style="width: 100px"
